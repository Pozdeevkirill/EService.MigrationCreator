...
{
    public class VsTheme : DependencyObject
    {
        ...
        public DependencyProperty UseVsThemeProperty;

        public VsTheme()
        {
            UseVsThemeProperty = DependencyProperty.Register("UseVsTheme", typeof(bool), typeof(VsTheme),
                                        new FrameworkPropertyMetadata(false,
                                            FrameworkPropertyMetadataOptions.AffectsMeasure |
                                            FrameworkPropertyMetadataOptions.AffectsRender,
                                            new PropertyChangedCallback(UseVsThemePropertyChanged)));
        }

        public bool UseVsTheme { get; set; }
        ...
        public static void SetUseVsTheme(UIElement element, bool value)
        {
            if (value)
            {
                ...
                ShouldBeThemed(((ContentControl)element));
            }
            else
            {
                ShouldNotBeThemed(((ContentControl)element));
            }
        ...
        private static void ShouldBeThemed(FrameworkElement control)
        {
        ...
        private static void ShouldNotBeThemed(FrameworkElement control)
        {
            if (control.Resources != null)
            {
